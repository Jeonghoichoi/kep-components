...
const IframeChipDeletable = () => {
    const [state, setState] = useState<string[]>(["Deletable Chip 01", "Deletable Chip 02", "Deletable Chip 03"]);
    return (
      <div className="flex flex-col gap-5 mt-12">
        <div className="flex min-w-0 items-center text-lg text-slate-900 dark:text-gray-400">Deletable</div>
  ...
  export default IframeChipDeletable;
