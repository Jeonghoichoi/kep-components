const IframeIconWithButtonGroup = () => {
  ...
  return (
    <div className="flex flex-col gap-5 mt-12">
      <div className="flex min-w-0 items-center text-lg text-slate-900">Group buttons with icons</div>
...
export default IframeIconWithButtonGroup;
