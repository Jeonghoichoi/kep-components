  ...
  return (
    <div className="flex flex-col gap-5 mt-6">
      <div className="flex items-center justify-between">
        <div className="flex min-w-0 items-center text-slate-900 dark:text-gray-400">Primary Tabs</div>
      </div>
      <div className="flex flex-col p-6 bg-red-50 md:px-2 border-gray-600 border border-solid rounded-lg">
