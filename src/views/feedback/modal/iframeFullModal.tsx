  ...
  return (
    <>
      <div className="flex flex-col gap-5 mt-12">
        <h2 className="text-lg text-slate-900 dark:text-gray-400">Full Page Modal</h2>
        <div className="p-6 border-gray-200 border border-solid rounded-lg relative h-92">
          ...
          {isOpen && <FullModal onToggle={onToggle} />}
        </div>
      </div>
    </>
  );
...
export default IframeFullModal;
